...
public class HamburguesasEspeciales implements Menu {
    ...
    public HamburguesasEspeciales() {
        ...
        agregarComida("Hamburguesa de res", "Hamburguesa que contiene dos rebanadas de pan y una rebanada de carne de res de marte, incluye papas fritas.", 0, true, false);
        agregarComida("Hamburguesa vegana", "Hamburguesa que contiene dos rebanadas de pan, dos rebanadas de jitomate y una rebanada de lechuga, todos estos ingredientes fueron cosechados en Venus.", 1, false, true);
        agregarComida("Hamburguesa de pizza", "Hamburguesa que contiene 2 rebanadas de pan integral, 3 rebanadas de pizza y 3 pedazos de carne.", 3, true, false);
        agregarComida("Hamburguesa mega alta en proteina", "Hamburguesa que contiene 4 rebanadas de pan, 8 pedazos de carne, 3 pedazo de pollo, salsa BBQ, lechuga, jitomate, aros de cebolla y papas fritas, ¡pesa en total 4.6kg!", 4, true, false);
    }
